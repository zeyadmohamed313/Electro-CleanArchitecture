...
{
    public class UpdateCategoryValidations:AbstractValidator<UpdateCategoryModel>
    {
        #region Fields
        ...
        #region Constructor
        public UpdateCategoryValidations(IStringLocalizer<SharedResourses> stringLocalizer)
        {
