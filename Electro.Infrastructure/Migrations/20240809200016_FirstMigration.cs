        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopSelling = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ImageURL = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    DateAdded = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    LastUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "Unknown"),
                    Brand = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Dimensions = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "4x4"),
                    ...
                    ShippingWeight = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ShippingCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Rating = table.Column<int>(type: "int", maxLength: 5, nullable: false, defaultValue: 0),
                    NumberOfStarts = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_FavouriteLists_FavouriteListId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavouriteItems_FavouriteLists_FavoriteListId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Method = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "CreditCard"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavouriteItem_FavoriteListId",
                table: "FavouriteItems",
                column: "FavoriteListId");

            migrationBuilder.CreateIndex(
                name: "IX_FavouriteItem_ProductId",
                table: "FavouriteItems",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_Price_StockQuantity",
                table: "Products",
